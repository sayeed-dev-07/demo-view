...
const AnimatedButton = ({ text = "View More", href = "#" }) => {
    ...
    const handleMouseEnter = contextSafe(() => {
        ...
        gsap.to(textRef.current, {
            color: '#fff', // Adjust variable name if necessary
            duration: 0.5,
            ease: "power3.out",
            overwrite: "auto"
        });
    ...
    return (
        <a
            ...
            className="relative  flex items-center gap-3 px-6 py-3  border border-current/30 text-xs font-bold uppercase tracking-widest overflow-hidden cursor-pointer selection:bg-background selection:text-foreground will-change-transform focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-secondary"
        >
            ...
            <span ref={textRef} className="relative flex w-full items-center justify-center gap-2 z-10 font-medium">
                {text}
            </span>
