...
const ErakitAbout = () => {
    ...
    useGSAP(() => {
        ...
        // It waits for SplitText and Image clip-paths to configure, then smoothly reveals the page.
    ...
    return (
        // Added ref={mainRef} and Tailwind's `invisible` class (visibility: hidden)
        <div ref={mainRef} className='invisible bg-[#f4f4f4] text-gray-900 min-h-screen selection:bg-black selection:text-white overflow-hidden font-sans'>
            ...
            <div className='h-screen w-full flex flex-col lg:flex-row'>
                ...
                {/* right side  */}
                <div className='w-full lg:w-1/2 h-[70vh] lg:h-full relative mt-8 lg:mt-0'>
                    <ImgAnimation
                        scroll={false}
